...
$(function() { 
    ...
    load_nama('<?php echo ($this->session->userdata('role') == 'user' ? $this->session->userdata('_id') : ''); ?>')
    //Buku 1
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="slcAgta" name="slcAgta">
                                            ...
                                            <option <?php echo ($agt->ID_ANGGOTA == $this->session->userdata('_id') ? 'selected' : ''); ?>><?php echo $agt->ID_ANGGOTA ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tbNama" id="tbNama" class="form-control" placeholder="Nama Anggota" readonly="readonly">
                                    </div>
                                </div>
                            </div>
